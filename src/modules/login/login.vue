<template>
        ...
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-4 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    ...
                    <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">XXX</div>
                </div>
            </div>
            <div class="mt-2 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-2 xl:px-24 xl:max-w-2xl">
    ...
    <div class="REMOVE-THIS-ELEMENT-IF-YOU-ARE-USING-THIS-PAGE hidden treact-popup fixed inset-0 flex items-center justify-center"
        ...
        <div class="max-w-lg p-8 sm:pb-4 bg-white rounded shadow-lg text-center sm:text-left">
            ...
            <p>I recently released Treact, a <span class="font-bold">free</span> TailwindCSS Component Kit built with React.
            </p>
